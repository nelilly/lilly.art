  ...
  return (
    <>
      <section className={funHouse}>
        ...
        <p>The World is filled with too many wonderful things to concentrate on one thing alone. Being a dilettante is being a consumate dabbler. It’s “and the rest”; the Professor <em>and</em> Mary-Ann. It’s running, and hiking, and archaeology, and the technology behind art, and mental models of the self, and why magenta isn’t real, and nutrition in space, and why books are books, and why is there time. It’s everything you do that doesn’t fit into neat little categories. It’s things that you don’t have to do but you can’t not do. It’s understanding that it’s okay to be a epistemological butterfly, and flit from subject to topic to category, learning new things.</p>
        <article>
          <h3>A Zine Scene</h3>
